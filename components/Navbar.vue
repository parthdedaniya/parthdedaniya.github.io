  ...
  <nav class="fixed top-0 left-0 right-0 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800 bg-white/90 dark:bg-[#121212]/90 transition-colors duration-300" style="z-index: 50;">
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between h-16">
        ...
        <!-- Desktop Navigation -->
        <div class="hidden md:flex items-center space-x-8" v-motion-fade-visible>
          <a 
            href="#hero"
      ...
      >
        <div v-if="isMobileMenuOpen" class="md:hidden pb-4 border-t border-gray-200 dark:border-gray-700 mt-2">
